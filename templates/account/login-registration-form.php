        ...
        <div class="<?php Helper::directorist_row(); ?>">
            ...
            <div class="directorist-col-md-6 directorist-offset-md-3 directorist-login-wrapper directorist-authentication <?php echo esc_attr( $active_form === 'signin' ? 'active' : '' ); ?>">
                <div class="atbdp_login_form_shortcode directorist-authentication__form">
                    ...
                    <?php /* ---- Registration success notice ---- */ ?>
                    ...
                    <?php if ( directorist_is_email_verification_enabled() && ! empty( $_GET['verification'] ) && is_email( $user_email ) ) : ?>
                        <p class="directorist-alert directorist-alert-success">
                            <span>
                                ...
                                echo wp_kses(
                                    sprintf(
                                        __( "Thank you for signing up! To complete the registration, please verify your email address by clicking on the link we have sent to your email.<br><br>If you didn't find the verification email, please check your spam folder. If you still can't find it, click on the <a href='%s'>Resend confirmation email</a> to have a new email sent to you.", 'directorist' ),
                                        esc_url( $send_confirm_mail_url )
                                    ),
                                    [ 'a' => [ 'href' => [] ], 'br' => [] ]
                                );
                                ?>
                    ...
                    <?php /* ---- Resend verification notice ---- */ ?>
                    <?php if ( directorist_is_email_verification_enabled() && ! empty( $_GET['send_verification_email'] ) ) : ?>
                        <p class="directorist-alert directorist-alert-success">
                            <span>
                                <?php echo wp_kses(
                                    __( "Thank you for requesting a new verification email. Please check your inbox and verify to complete the registration.<br><br>If you still can't find it, please check your spam folder. And please contact if you are still having trouble.", 'directorist' ),
                                    [ 'br' => [] ]
                                ); ?>
                            </span>
                        </p>
                    ...
                    <?php /* ---- Password reset / email confirm flow ---- */ ?>
                    <?php if ( is_email( $user_email ) && ! empty( $key ) ) : ?>

                        <?php $user = get_user_by( 'email', $user_email ); ?>
                        ...
                        <?php else : ?>
                            <?php $is_valid_password_reset_key = check_password_reset_key( $key, $user->user_login ); ?>

                            <?php if ( is_wp_error( $is_valid_password_reset_key ) ) : ?>
                                <p class="directorist-alert directorist-alert-danger">
                            ...
                            <?php else : ?>
                                ...
                                <?php /* -- Handle password reset form submission -- */ ?>
                                <?php if ( ! empty( $_POST['directorist_reset_password'] ) && directorist_verify_nonce( 'directorist-reset-password-nonce', 'reset_password' ) ) : ?>
                                    <?php
                                    // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.MissingUnslash, WordPress.Security.ValidatedSanitizedInput.InputNotSanitized
                                    ...
                                    <?php if ( empty( $password_1 ) || empty( $password_2 ) ) : ?>
                                        <p class="atbd_reset_warning directorist-alert directorist-alert-danger">
                                            <?php esc_html_e( 'Passwords cannot be empty.', 'directorist' ); ?>
                                        </p>

                                    <?php elseif ( $password_1 !== $password_2 ) : ?>
                                        <p class="atbd_reset_error directorist-alert directorist-alert-danger">
                                            <?php esc_html_e( 'Passwords do not match!', 'directorist' ); ?>
                                        </p>

                                    <?php else : ?>
                                        <?php
                                        wp_set_password( $password_2, $user->ID );
                                        // Password reset is via email, so we can consider it verified
                                ...
                                <?php /* -- Show password reset form -- */ ?>
                                <?php if ( ! empty( $_GET['password_reset'] ) ) : ?>
                                    <?php include ATBDP_DIR . 'templates/account/password-reset-form.php'; ?>
                                <?php endif; ?>

                                <?php /* -- Email confirmation -- */ ?>
                                <?php if ( ! empty( $_GET['confirm_mail'] ) ) : ?>
                                    <?php
                                    delete_user_meta( $user->ID, 'directorist_user_email_unverified' );
                            ...
                            <?php endif; // valid reset key ?>
                        <?php endif; // user found ?>

                    <?php /* ---- Normal login form ---- */ ?>
                    <?php else : ?>
                        ...
                        <form action="#" id="directorist__authentication__login" method="POST" class="directorist__authentication__signin">
                            ...
                            <div class="directorist-form-group atbd_login_btn_wrapper directorist-mb-15 directorist-authentication__form__btn-wrapper">
                                <button class="directorist-btn directorist-btn-block directorist-authentication__form__btn" type="submit" value="<?php echo esc_attr( $log_button ); ?>" name="submit" aria-label="Signin Button">
                        ...
                        <?php if ( directorist_is_user_registration_enabled() ) : ?>
                            <div class="directorist-authentication__form__toggle-area">
                                ...
                                <button class="directorist-authentication__btn directorist-authentication__btn--signup" aria-label="Signup Button">
                                    <?php echo esc_html( $reg_linktxt ); ?>
                                </button>
                            </div>
                        <?php endif; ?>

                        <?php /* ---- Password recovery form ---- */ ?>
                        <?php
                        $error   = '';
                        $success = '';
                        ...
                        if ( isset( $_POST['action'] ) && 'reset' === $_POST['action'] && directorist_verify_nonce() ) :
                            ...
                            if ( empty( $email ) ) {
                                ...
                                /* translators: %1$s: site name, %2$s: user name, %3$s: password reset link */
                                $message = sprintf(
                                    __(
                                ...
                                $message   = wp_kses( $message, [ 'br' => [], 'strong' => [], 'a' => [ 'href' => [] ] ] );
                            ...
                            if ( ! empty( $error ) ) {
                                echo '<div class="message"><p class="error directorist-alert directorist-alert-danger">'
                                    . wp_kses( sprintf( __( '<strong>ERROR: </strong> %s', 'directorist' ), esc_html( $error ) ), [ 'strong' => [] ] )
                                    . '</p></div>';
                            }

                            if ( ! empty( $success ) ) {
                                echo '<div class="error_login"><p class="success directorist-alert directorist-alert-success">'
                                    . esc_html( $success )
                                    . '</p></div>';
                            }
                        ...
                        <div id="recover-pass-modal" class="directorist-mt-15 directorist-authentication__form__recover-pass-modal">
                            <form action="#" method="post">
                                <fieldset class="directorist-form-group">
                                    ...
                                    <input
                                        type="text"
                                        class="directorist-mb-15 directorist-form-element"
                                        name="user_login"
                                        id="reset_user_login"
                                        value="<?php echo isset( $_POST['user_login'] ) ? esc_attr( sanitize_text_field( wp_unslash( $_POST['user_login'] ) ) ) : ''; ?>"
                                        placeholder="<?php echo esc_attr( $recpass_placeholder ); ?>"
                                        required="required"
                                    />
                                    <div class="directorist-authentication__form__btn-wrapper">
                                        <input type="hidden" name="action" value="reset" />
                                        <button type="submit" class="directorist-btn directorist-authentication__form__btn" id="directorist__authentication__submit" aria-label="Recover Password Button">
                                            <?php echo esc_html( $recpass_button ); ?>
                                        </button>
                    ...
                    <?php endif; // end login form / password reset split ?>

                </div><!-- /.atbdp_login_form_shortcode -->
            </div><!-- /.directorist-login-wrapper -->
            ...
            <div class="directorist-col-md-6 directorist-offset-md-3 directorist-registration-wrapper directorist-authentication <?php echo esc_attr( $active_form === 'signup' ? 'active' : '' ); ?>">
                <div class="directory_register_form_wrap directorist-authentication__form">
                    ...
                    <?php /* ---- Registration success / error messages ---- */ ?>
                    <div class="add_listing_title atbd_success_mesage directorist-authentication__message">
                        <?php if ( ! empty( $_GET['registration_status'] ) && true == $_GET['registration_status'] ) : ?>
                            <?php if ( empty( $display_password_reg ) || 'yes' != $display_password_reg ) : ?>
                                <p style="padding: 20px" class="alert-success directorist-alert directorist-alert-success">
                                    <span>
                                        <?php esc_html_e( 'Go to your inbox or spam/junk and get your password.', 'directorist' ); ?>
                                        <?php
                                        $output = sprintf(
                                            __( 'Click %s to login.', 'directorist' ),
                                            '<a href="' . ATBDP_Permalink::get_login_page_link() . '"><i style="color: red">' . __( 'Here', 'directorist' ) . '</i></a>'
                                        );
                                        echo wp_kses_post( $output );
                                        ?>
                                    </span>
                            ...
                            <?php else : ?>
                                <p style="padding: 20px" class="alert-success directorist-alert directorist-alert-success">
                                    <span>
                                        <?php esc_html_e( 'Registration completed. Please check your email for confirmation.', 'directorist' ); ?>
                                        <?php
                                        $output = sprintf(
                                            __( 'Or click %s to login.', 'directorist' ),
                                            '<button class="directorist-authentication__btn directorist-authentication__btn--signin"><span style="color: red">' . __( 'Here', 'directorist' ) . '</span></button>'
                                        );
                                        echo wp_kses_post( $output );
                                        ?>
                                    </span>
                        ...
                        <p style="padding: 20px; display:none;" class="alert-danger directorist-register-error">
                            <?php directorist_icon( 'las la-exclamation-triangle' ); ?>
                        </p>
                    </div>
                    ...
                    <form action="#" method="post" class="directorist__authentication__signup">
                        ...
                        <div class="directorist-form-group directorist-mb-35">
                            <label for="directorist__authentication__signup__username">
                                <?php echo esc_html( $username ); ?> <strong class="directorist-form-required">*</strong>
                            </label>
                            <input
                                id="directorist__authentication__signup__username"
                        ...
                        <?php /* -- Email -- */ ?>
                        <div class="directorist-form-group directorist-mb-35">
                            <label for="directorist__authentication__signup__email">
                                <?php echo esc_html( $email ); ?> <strong class="directorist-form-required">*</strong>
                            </label>
                            <input
                                id="directorist__authentication__signup__email"
                                class="directorist-form-element"
                                type="text"
                                name="email"
                        ...
                        <?php if ( ! empty( $display_fname ) && 'yes' == $display_fname ) : ?>
                            <div class="directorist-form-group directorist-mb-35">
                                <label for="directorist__authentication__signup__fname">
                                    ...
                                    <?php echo ( ! empty( $require_fname ) && 'yes' == $require_fname ? '<strong class="directorist-form-required">*</strong>' : '' ); ?>
                                </label>
                                <input
                                    ...
                                    type="text"
                                    name="fname"
                                    value="<?php echo isset( $_REQUEST['fname'] ) ? esc_attr( sanitize_text_field( wp_unslash( $_REQUEST['fname'] ) ) ) : ''; ?>"
                                    <?php echo ( ! empty( $require_fname ) && 'yes' == $require_fname ? 'required' : '' ); ?>
                                >
                            </div>
                        <?php endif; ?>
                        ...
                        <?php if ( ! empty( $display_lname ) && 'yes' == $display_lname ) : ?>
                            <div class="directorist-form-group directorist-mb-35">
                                <label for="directorist__authentication__signup__lname">
                                    ...
                                    <?php echo ( ! empty( $require_lname ) && 'yes' == $require_lname ? '<strong class="directorist-form-required">*</strong>' : '' ); ?>
                                </label>
                                <input
                                    class="directorist-form-element"
                                    id="directorist__authentication__signup__lname"
                                    type="text"
                                    name="lname"
                                    value="<?php echo isset( $_REQUEST['lname'] ) ? esc_attr( sanitize_text_field( wp_unslash( $_REQUEST['lname'] ) ) ) : ''; ?>"
                                    <?php echo ( ! empty( $require_lname ) && 'yes' == $require_lname ? 'required' : '' ); ?>
                                >
                            </div>
                        <?php endif; ?>
                        ...
                        <?php if ( ! empty( $display_website ) && 'yes' == $display_website ) : ?>
                            <div class="directorist-form-group directorist-mb-35">
                                <label for="directorist__authentication__signup__website">
                                    ...
                                    <?php echo ( ! empty( $require_website ) && 'yes' == $require_website ? '<strong class="directorist-form-required">*</strong>' : '' ); ?>
                                </label>
                                <input
                                    id="directorist__authentication__signup__website"
                                    class="directorist-form-element"
                                    type="text"
                                    name="website"
                                    value="<?php echo isset( $_REQUEST['website'] ) ? esc_url( sanitize_text_field( wp_unslash( $_REQUEST['website'] ) ) ) : ''; ?>"
                                    <?php echo ( ! empty( $require_website ) && 'yes' == $require_website ? 'required' : '' ); ?>
                                >
                            </div>
                        <?php endif; ?>
                        ...
                        <?php if ( ! empty( $display_bio ) && 'yes' == $display_bio ) : ?>
                            <div class="directorist-form-group directorist-mb-35">
                                <label for="directorist__authentication__signup__bio">
                                    ...
                                    <?php echo ( ! empty( $require_bio ) && 'yes' == $require_bio ? '<strong class="directorist-form-required">*</strong>' : '' ); ?>
                                </label>
                                <textarea
                                    id="directorist__authentication__signup__bio"
                                    class="directorist-form-element"
                                    name="bio"
                                    rows="10"
                                    placeholder="<?php echo esc_html( $bio ); ?>"
                                    <?php echo ( ! empty( $require_bio ) && 'yes' == $require_bio ? 'required' : '' ); ?>
                        ...
                        <?php if ( ! empty( $registration_privacy ) && 'yes' == $registration_privacy ) : ?>
                            <div class="atbd_privacy_policy_area directory_regi_btn directorist-checkbox directorist-mb-20">
                                <input
                                    id="directorist__authentication__signup__privacy_policy"
                                    type="checkbox"
                                    name="privacy_policy"
                                    <?php echo ( isset( $privacy_policy ) && 'on' === $privacy_policy ) ? 'checked="checked"' : ''; ?>
                                >
                                <label for="directorist__authentication__signup__privacy_policy" class="directorist-checkbox__label">
                        ...
                        <?php if ( ! empty( $enable_registration_terms ) && 'yes' == $enable_registration_terms ) : ?>
                            <div class="atbd_term_and_condition_area directory_regi_btn directorist-checkbox directorist-mb-30">
                                <input
                                    id="directorist__authentication__signup__listing_t"
                                    type="checkbox"
                                    name="t_c_check"
                                    <?php echo ( isset( $t_c_check ) && 'on' === $t_c_check ) ? 'checked="checked"' : ''; ?>
                                >
                                <label for="directorist__authentication__signup__listing_t" class="directorist-checkbox__label">
                                    <?php echo esc_attr( $terms_label ); ?>
                        ...
                        <div class="directory_regi_btn directorist-authentication__form__toggle-area">
                            <p>
                                ...
                                <button class="directorist-authentication__btn directorist-authentication__btn--signin">
                                    <?php echo esc_html( $log_linkingmsg ); ?>
                                </button>
                            </p>
                        </div>
            ...
            </div><!-- /.directorist-registration-wrapper -->
            <?php endif; // registration enabled ?>
